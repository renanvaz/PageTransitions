...
:: Android packaging
set AND_CERT_NAME="PageTransitions"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PageTransitions.p12
...
set IOS_PROVISION=cert\PageTransitions.mobileprovision
...
set APP_ID=air.PageTransitions

:: Output packages
set DIST_PATH=dist
set DIST_NAME=PageTransitions
